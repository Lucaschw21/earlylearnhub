        ...
        <section>
            <div class="wrapper-edit">
                <div class="login-form">
                    ...
                    <form method="post" id="form" onsubmit="return checkInputs(event)" action="adminEditProf-backend.php">
                        <div class="input-box">
                            <span class="icon"><ion-icon name="person"></ion-icon></span>
                            <?php //echo "<input type='text' style = 'font-weight: normal' id='username' name='chg-username' value='". $row["User_Username"] . "'>"?>
                            <input type="text" style="font-weight: normal" id="username" name="chg-username" value="<?php echo $row["Admin_Name"]; ?>">
                        ...
                        <div class="input-box">
                            ...
                            <input type="email" style="font-weight: normal" id="email" name="chg-email" value="<?php echo $row["Admin_Email"]; ?>">
